const ubigeoPeru = {
  ...
  "Ancash": {
    ...
    "Bolognesi": ["Chiquian", "Abelardo Romero", "Antonio Raymondi", "Aquia", "Cajacay", "Canis", "Colquioc", "Huallanca", "Huasta", "Huayllacayan", "La Primavera", "Mangas", "Pacllon", "San Miguel de Corpanqui", "Ticllos"],
  ...
  "Apurímac": {
    ...
    "Andahuaylas": ["Andahuaylas", "Andarapa", "Chiara", "Huancarama", "Huancaray", "Huayana", "Kishuara", "Pacobamba", "Pacucha", "Pampachiri", "Pomacocha", "San Antonio de Cachi", "San Jerónimo", "San Miguel de Chaccrampa", "Santa María de Chicmo", "Talavera", "Tumay Huaraca", "Turpo", "José María Arguedas"],
    ...
    "Grau": ["Chuquibambilla", "Curpahuasi", "Gamarra", "Huayllati", "Mamara", "Micaela Bastidas", "Pataypampa", "Progreso", "San Antonio", "Santa Cruz", "Turpay", "Vilcabamba", "Virundo", "Curasco"]
  },
  "Arequipa": {
    ...
    "Caylloma": ["Chivay", "Achoma", "Cabanaconde", "Callalli", "Coporaque", "Huambo", "Huanca", "Ichupampa", "Lari", "Lluta", "Maca", "Madrigal", "Majes", "San Antonio de Chuca", "Sibayo", "Tapay", "Tisco", "Tuti", "Yanca", "Yanque"],
  ...
  "Ayacucho": {
    ...
    "Huanta": ["Huanta", "Ayahuanco", "Huamanguilla", "Iguain", "Luricocha", "Santillana", "Sivia", "Llochegua", "Canayre"],
  ...
  "Cajamarca": {
    ...
    "Santa Cruz": ["Santa Cruz", "Andabamba", "Catache", "Chancaybaños", "La Esperanza", "Ninabamba", "Pulan", "Saucepampa", "Sexi", "Syquio", "Yauyucan"]
  },
  "Callao": {
  ...
  "Cusco": {
    ...
    "La Convención": ["Santa Ana", "Echarate", "Huayopata", "Maranura", "Ocobamba", "Quellouno", "Kimbiri", "Teresa", "Vilcabamba", "Pichari", "Inkawasi", "Villa Virgen"],
  ...
  "Huánuco": {
    "Huánuco": ["Huanuco", "Amarilis", "Chinchao", "Churubamba", "Margos", "Quisqui", "San Francisco de Cayran", "San Pedro de Chaulan", "Santa María del Valle", "Yarumayo", "Pillco Marca", "Yacus"],
    ...
    "Leoncio Prado": ["Rupa-Rupa", "Daniel Alomía Robles", "Hermílio Valdizán", "José Crespo y Castillo", "Luyando", "Mariano Damaso Beraun"],
  ...
  "Junín": {
    "Huancayo": ["Huancayo", "Carhuacallanca", "Chacapampa", "Chicche", "Chilca", "Chongos Alto", "Chupuro", "Colca", "Cullhuas", "El Tambo", "Huacrapuquio", "Hualhuas", "Huancan", "Huasicancha", "Huayucachi", "Ingenio", "Pariahuanca", "Pilcomayo", "Pucara", "Quichuay", "Quilcas", "San Agustín", "San Jerónimo de Tunan", "Saño", "Sapallanga", "Sicaya", "Santo Domingo de Acobamba", "Viques"],
    ...
    "Jauja": ["Jauja", "Acolla", "Apata", "Ataura", "Canchayllo", "Curicaca", "El Mantaro", "Huamali", "Huaripampa", "Huertas", "Janjaillo", "Julcán", "Leonor Ordóñez", "Llocllapampa", "Marco", "Masma", "Masma Chicche", "Molinos", "Monobamba", "Muqui", "Muquiyauyo", "Paca", "Paccha", "Pancan", "Parco", "Pomacancha", "Ricran", "San Lorenzo", "San Pedro de Chunan", "Sincos", "Tunan Marca", "Yauli", "Yauyos"],
  ...
  "Puno": {
    ...
    "Huancané": ["Huancané", "Coata", "Huatasani", "Inchupalla", "Pusi", "Rosaspata", "Taraco", "Vilque Chico"],
  ...
  "Tacna": {
    "Tacna": ["Tacna", "Alto de la Alianza", "Calana", "Ciudad Nueva", "Coronel Gregorio Albarracín Lanchipa", "Inclan", "Pachia", "Palca", "Pocollay", "Sama"],
...
function setupUbigeo(departamentoId, provinciaId, distritoId) {
    ...
    depSelect.addEventListener('change', function() {
        ...
        if (dep && ubigeoPeru[dep]) {
            for (let prov in ubigeoPeru[dep]) {
    ...
    provSelect.addEventListener('change', function() {
        ...
        if (dep && prov && ubigeoPeru[dep][prov]) {
            ubigeoPeru[dep][prov].forEach(dist => {
